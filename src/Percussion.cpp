...
struct Percussion : Module {
  ...
  enum LightId { PERCUSSION_LIGHT, LIGHTS_LEN };
  ...
  int getSampleLengthByIndex(int index) {
    switch (index) {
    case 0:
      return Percussion1_len;
    case 1:
      return Percussion2_len;
    case 2:
      return Percussion3_len;
    case 3:
      return Percussion4_len;
    case 4:
      return Percussion5_len;
    case 5:
      return Percussion6_len;
    case 6:
      return Percussion7_len;
    case 7:
      return Percussion8_len;
    case 8:
      return Percussion9_len;
    case 9:
      return Percussion10_len;
    case 10:
      return Percussion11_len;
    case 11:
      return Percussion12_len;
    case 12:
      return Percussion13_len;
    case 13:
      return Percussion14_len;
    case 14:
      return Percussion15_len;
    case 15:
      return Percussion16_len;
    default:
      return 0;
    }
  }
  ...
  void process(const ProcessArgs &args) override {
    ...
    if (triggered) {
      ...
      if (inputs[SAMPLECVIN_INPUT].isConnected()) {
        ...
        sampleIndex += (int)round(
            cv * (numSamples / 10.f)); // 10V range maps to 0–numSamples
      }
    ...
    PercussionLightBrightness = std::max(
        0.f, PercussionLightBrightness - (float)(args.sampleTime * 10.f));
    lights[PERCUSSION_LIGHT].setBrightnessSmooth(PercussionLightBrightness,
                                                 args.sampleTime);
    ...
    if (playing && currentSample) {
      ...
      if ((int)samplePos >= numSamplesHalf) {
        ...
        int16_t s1s = (int16_t)(currentSample[idx * 2] |
                                (currentSample[idx * 2 + 1] << 8));
        int16_t s2s = (int16_t)(currentSample[nextIdx * 2] |
                                (currentSample[nextIdx * 2 + 1] << 8));
        ...
        if (inputs[DECAYCVIN_INPUT].isConnected())
          decayParam +=
              inputs[DECAYCVIN_INPUT].getVoltage() / 10.f; // ±5V → ±0.5
...
struct PercussionWidget : ModuleWidget {
  PercussionWidget(Percussion *module) {
    ...
    setPanel(createPanel(
        asset::plugin(pluginInstance, "res/panels/Percussion.svg")));
