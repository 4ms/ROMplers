...
struct Percussion : OneShotBaseModule<Percussion> {
  static constexpr std::array samples = {
      ...
      Sample{Percussion7},  Sample{Percussion8},  Sample{Percussion9},
      Sample{Percussion10}, Sample{Percussion11}, Sample{Percussion12},
      Sample{Percussion13}, Sample{Percussion14}, Sample{Percussion15},
      Sample{Percussion16},
  };
};
