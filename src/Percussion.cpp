...
struct PercussionWidget : ModuleWidget {
	PercussionWidget(Percussion* module) {
		...
		addParam(createParamCentered<Knob9mm>(mm2px(Vec(10.16, 15.971)), module, Percussion::SAMPLE_PARAM));
		addParam(createParamCentered<Knob9mm>(mm2px(Vec(10.16, 39.997)), module, Percussion::PITCH_PARAM));
		addParam(createParamCentered<Knob9mm>(mm2px(Vec(10.16, 64.029)), module, Percussion::DECAY_PARAM));
