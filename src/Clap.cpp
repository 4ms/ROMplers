...
struct Clap : OneShotBaseModule<Clap> {
  ...
  static constexpr std::array samples = {
      ...
      Sample{Clap5},  Sample{Clap6},  Sample{Clap7},  Sample{Clap8},
      Sample{Clap9},  Sample{Clap10}, Sample{Clap11}, Sample{Clap12},
      Sample{Clap13}, Sample{Clap14}, Sample{Clap15}, Sample{Clap16},
  };
};
