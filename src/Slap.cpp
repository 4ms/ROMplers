...
struct Slap : Module {
  ...
  void process(const ProcessArgs &args) override {
    ...
    lights[SLAP_LIGHT].setBrightnessSmooth(slapLightBrightness,
                                           args.sampleTime);
...
struct SlapWidget : ModuleWidget {
  SlapWidget(Slap *module) {
    ...
    addParam(createParamCentered<Knob9mm>(mm2px(Vec(10.16, 12.45)), module,
                                          Slap::OCTAVE_PARAM));
    addParam(createParamCentered<Knob9mm>(mm2px(Vec(10.16, 55.002)), module,
                                          Slap::DECAY_PARAM));
    addParam(createParamCentered<LEDBezel>(mm2px(Vec(10.16, 84.3)), module,
                                           Slap::PUSH_PARAM));
    addChild(createLightCentered<LEDBezelLight<WhiteLight>>(
        mm2px(Vec(10.16, 84.3)), module, Slap::SLAP_LIGHT));

    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(10.16, 25.15)), module,
                                             Slap::OCTAVECVIN_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(10.16, 38.199)), module,
                                             Slap::PITCHCVIN_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(10.16, 67.702)), module,
                                             Slap::DECAYCVIN_INPUT));
