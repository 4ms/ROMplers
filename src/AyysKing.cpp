...
struct AyysKingWidget : ModuleWidget {
	AyysKingWidget(AyysKing* module) {
		...
		addParam(createParamCentered<Davies1900hBlack>(mm2px(Vec(49.731, 15.501)), module, AyysKing::MAINVOL_PARAM));
		...
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(49.731, 30.801)), module, AyysKing::SUM_OUTPUT));
