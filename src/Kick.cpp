...
struct Kick : Module {
  ...
  enum LightId { KICK_LIGHT, LIGHTS_LEN };
  ...
  void process(const ProcessArgs &args) override {
    ...
    if (kickLightBrightness < 0.f)
      kickLightBrightness = 0.f;
