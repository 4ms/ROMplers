...
struct ClosedHat : OneShotBaseModule<ClosedHat> {
  ...
  static constexpr std::array samples = {
      ...
      Sample{ClosedHat7},  Sample{ClosedHat8},  Sample{ClosedHat9},
      Sample{ClosedHat10}, Sample{ClosedHat11}, Sample{ClosedHat12},
      Sample{ClosedHat13}, Sample{ClosedHat14}, Sample{ClosedHat15},
      Sample{ClosedHat16},
  };
};
